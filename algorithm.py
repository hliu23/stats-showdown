# TO DO: install python and openpyxl package
from openpyxl import load_workbook
import sys

# TO DO: replace workbook name and worksheet name
WB = load_workbook("<PLACEHOLDER_WORKBOOK_NAME>.xlsx", read_only=True)
WS = WB["<PLACEHOLDER_WORKSHEET_NAME"]

# TO DO: run with "py algorithm.py"

# load data from workbook into nested list
COLS_OF_INTEREST = [1, 4, 7, 9, 10, 21, 23, 24, 25, 31, 32]
data = []
...
CORREL_FACTORS = [-0.45, 0.3, 0.37, -0.33, 0.22, 0.28, -0.38, 0.45, 0.44, 0.43]
