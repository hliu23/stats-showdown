...
WEIGHT = [-7.369519723, 3.207527431, 2.098710386, -1.634276411, 1.215039434, -3.164313497, 4.014363826, 0.742103775, 2.474446861]
...
# multiply data by weights calculated ahead of time (correlation coefficient times slope) and sum results for a row
sort_list = []
for row in range(len(data)):
  result = 0
  for col in range(1, len(data[row])):
    val = data[row][col]
    result += WEIGHT[col-1] * val
